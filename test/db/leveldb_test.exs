defmodule MerklePatriciaTree.DB.LevelDBTest do
  ...
  test "init creates an leveldb table" do
    db_name = "/tmp/db#{MerklePatriciaTree.Utils.random_string(20)}"
  ...
  test "get/1" do
    {_, db_ref} = LevelDB.init("/tmp/db#{MerklePatriciaTree.Utils.random_string(20)}")
  ...
  test "get!/1" do
    db = {_, db_ref} = LevelDB.init("/tmp/db#{MerklePatriciaTree.Utils.random_string(20)}")
